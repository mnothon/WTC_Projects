...
screen.screensize(400, 800)
# screen.setworldcoordinates(-250,-200,250,200)
...
def draw_obstacles():
    ...
    """
    for obstacle in crazy_maze.get_obstacles():
        border.speed(0)
        border._tracer(5)
        border.pensize(1)
        border.penup()
