...
class RobotTest {
    ...
    void forwardforward() {
        ...
        Command firstCommand = new ForwardCommand("10");
        Command secondCommand = new ForwardCommand("5");

        assertTrue(robot.handleCommand(firstCommand));
        assertTrue(robot.handleCommand(secondCommand));
